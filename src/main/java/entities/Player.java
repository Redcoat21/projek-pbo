...
public class Player extends Entity {
    ...
    private WeaponFactory<SwordType> swordFactory = (swordType, phase) -> switch(swordType) {
    ...
    private WeaponFactory<SpearType> spearFactory = (spearType, phase) -> switch(spearType) {
    ...
    private WeaponFactory<RangedType> rangedFactory = (rangedType, phase) -> switch (rangedType){
    ...
    @Override
    public void attack(Collideable target) {
        System.out.println("Attacking!");
    }

    /**
     * Used to change the player's weapon.
     * @param weaponType The type of the weapon, e.g. sword, spear, ranged.
     * @param changeInto The type of the weapon that the player will change into.
